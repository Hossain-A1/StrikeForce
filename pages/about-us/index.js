    ...
    <div className="wrapper section-padding">
      ...
      <div className="flex flex-col items-center gap-5">
        ...
        <p className="text-gray-500 w-5/6">
          ...
          opponent.It's Force is a combat simulation game that utilizes
          realistic physics and fast-paced action. The game puts players in
          control of a team of combat specialists, with each player controlling
          a different specialist. The team must work together to complete
          objectives and defeat enemies in a variety of environments. Players
          can customize their team's loadout and strategy to suit their style of
          play. The game also features a variety of multiplayer modes for
          competitive play.{" "}
        </p>
      </div>
      <Instructors />
