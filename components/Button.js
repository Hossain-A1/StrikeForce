...

  {
    variants: {
      color: {
        ...
        ghost: "bg-transparent border w-full text-center text-gray-700 hover:bg-gray-500/10",
        transparent: "bg-transparent border rounded-lg w-full text-center text-gray-700 hover:bg-gray-500/10",
      },
    },
    defaultVariants: {
      color: "green",
