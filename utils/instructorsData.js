export const instructorsData = [
  {
    ...
    btn: "Read more",
    description:
      "Martial boxing arts refer to the use of physical and mental discipline to defend oneself in combat. This can include a variety of styles of hand-to-hand combat, such as kickboxing, Muay Thai, karate, tae kwon do, judo, and aikido. Martial boxing arts also involve techniques to improve physical conditioning, such as stretching and strength training, as well as mental strategies to improve focus and concentration.",
    admit: "",
    name:"rico",
  ...
  },
  {
    ...
    btn: "Read more",
    description:
      "Martial Kung-fu arts are a form of traditional Chinese martial arts that utilize physical techniques such as kicks, punches, and throws as well as mental and spiritual techniques such as meditation and breathing exercises. This art form has been practiced for centuries and is known for its emphasis on flexibility, balance, and form. It is also known for its philosophical and spiritual aspects, as practitioners strive to achieve a state of harmony between body, mind, and spirit. ",
    admit: "",
    name:"nordan thik",
    headline:"This instructor has been trained in a variety of martial arts.",
  ...
  },
  {
    ...
    btn: "Read more",
    description:
      "Martial karate arts are a form of unarmed combat involving kicks, punches, elbow strikes, and knee strikes, as well as joint locks, throws, and blocks. The main purpose is to train oneself to be able to defend oneself in a physical altercation, while also developing discipline, respect, and self-confidence. In many cases, it also includes techniques from other martial arts, such as grappling, aikido, judo, and tae kwon do. ",
    admit: "",
    name:"smith",
    headline:"This instructor has been trained in a variety of martial arts.",
